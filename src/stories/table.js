...
import { createPageHeader } from './page-header/PageHeader';
import { createTables } from './table/tables';

export const createTableExample = () => {
  const article = document.createElement('main');
  article.className = 'col-12 px-md-4';

  const containerFluid = document.createElement('div');
  containerFluid.className = 'container-fluid';
  article.appendChild(containerFluid);

  const contentRow = document.createElement('div');
  contentRow.className = 'row';
  containerFluid.appendChild(contentRow);
  ...
  const pageHeader = createPageHeader({ state: 'Table' });
  contentRow.appendChild(pageHeader);

  const tableWrapper = document.createElement('div');
  tableWrapper.className = 'container-fluid table-responsive-lg';
  ...
  pageHeader.appendChild(tableWrapper);

  // const tables = createTables({
  //   striped: true,
  //   label: 'table-striped',
  // });
  // pageHeader.appendChild(tables);
