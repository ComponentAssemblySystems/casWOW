...
The CASim AI Chatbot (i.e. ASK CASim) is an interactive component that allows users to engage in conversations with an AI-powered assistant. It is designed to provide quick and accurate responses to user queries, enhancing the overall user experience on the platform.
...
<Canvas of={ChatbotStories.ChatInput} />
